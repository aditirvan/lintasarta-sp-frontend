...
import { MANAGEFLAVORTYPE } from '../namespace'
export const useType = () => {
    ...
    = useNamespacedActions(MANAGEFLAVORTYPE, ['fetchflavorstype','addFlavortype','editFlavortype','deleteFlavortype'])
    
    const { flavorstype, paginationtype } = useNamespacedState(MANAGEFLAVORTYPE, ['flavorstype', 'paginationtype'])
