<template>
  <v-dialog max-width="500" v-model="dialog">
    <v-card>
      ...
      <v-card-text>
        <p class="font-weight-bold">Full Name * <span class="red--text ml-2">{{ !member.fullname ? errors : '' }}</span>
        </p>
        <v-text-field
          maxlength="100"
      ...
      <v-card-text>
        <p class="font-weight-bold">Phone Number * <span class="red--text ml-2">{{ !member.phone ? errors : '' }}</span>
        </p>
        <v-text-field
      ...
      <v-card-text>
        <p class="font-weight-bold">Address * <span class="red--text ml-2">{{ !member.address ? errors : '' }}</span>
        </p>
        <v-text-field
          maxlength="100"
