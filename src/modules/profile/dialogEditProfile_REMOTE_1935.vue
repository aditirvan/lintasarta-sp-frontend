<template>
    <v-dialog max-width="500" v-model="dialog">
      <v-card>
        ...
        <v-card-text>
          <p class="font-weight-bold">Full Name * <span class="red--text text-xs ml-1" style="font-size:0.75em">{{ !member.fullname ? errors : '' }}</span></p>
          <v-text-field
            maxlength="100"
        ...
        <v-card-text>
          <p class="font-weight-bold">Phone Number * <span class="red--text text-xs ml-1" style="font-size:0.75em">{{ !member.phone ? errors : '' }}</span></p>
          <v-text-field
        ...
        <v-card-text>
          <p class="font-weight-bold">Address * <span class="red--text text-xs ml-1" style="font-size:0.75em">{{ !member.address ? errors : '' }}</span></p>
          <v-text-field
            maxlength="100"
