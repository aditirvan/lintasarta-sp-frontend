...
(function (t) {
  ...
  t.extend(s.prototype, {
    ...
    parseDate: function (e, i, s) {
      ...
      if (
        (-1 === g ? (g = new Date().getFullYear()) : 100 > g && (g += new Date().getFullYear() - (new Date().getFullYear() % 100) + (c >= g ? 0 : -100)),
        v > -1)
      )
        for (m = 1, _ = v; ; ) {
    ...
    _determineDate: function (e, i, s) {
      ...
      return (
        (a = a && "Invalid Date" == "" + a ? s : a), a && (a.setHours(0), a.setMinutes(0), a.setSeconds(0), a.setMilliseconds(0)), this._daylightSavingAdjust(a)
      );
    },
        ...
        if (e) {
          if ((t.ui.ddmanager && !this.options.dropBehaviour && t.ui.ddmanager.drop(this, e), this.options.revert)) {
            ...
            (o && "x" !== o) ||
              ...
              (o && "y" !== o) ||
                (a.top =
                  n.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)),
              (this.reverting = !0),
